...
// MongoDB Connection
console.log("📡 Connecting to MongoDB:", process.env.MONGO_URI ? "URI found" : "❌ No URI found in env");
...
(async () => {
  ...
  if (!exists) {
    console.log("👑 Creating Supreme Admin...");
    ...
    console.log("ℹ️ Supreme Admin already exists in DB");
  }
})();
...
app.post('/api/admin/login', async (req, res) => {
  ...
  try {
    ...
    console.log("📄 Admin record from DB:", admin ? "✅ Found" : "❌ Not found");
    ...
    console.log("🔍 Password match result:", isMatch ? "✅ Matched" : "❌ Wrong password");
    ...
    console.log("👑 Is Supreme Admin?:", supreme);
